...
Dùng lệnh xóa trigger để tiếp tục
...
<!-- 📸 ẢNH SỐ 1: Chụp tab Messages hiển thị các dòng PRINT báo giảm giá từng món -->
...
<!-- 📸 ẢNH SỐ 2: Chụp tab Messages so sánh 2 thông số SQL Server Execution Times -->
...
<!-- 📸 ẢNH SỐ 3: Chụp tab Results hoặc Messages hiển thị kết quả in ra nhiều bảng hóa đơn cùng lúc -->
